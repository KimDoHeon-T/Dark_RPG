...
Shader "KumaBeer/Stone_snow"
{
	Properties
	{
		...
		[ASEEnd]_Noisevalue("Noise value", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _SnownoiseTiling;
			float _Snownoisescale;
			float _Blendnormals;
			float _TriplanarNormalScale;
			float _Noisevalue;
			float _NoiseTiling;
			float _Detailmasktriplanar;
			float _TriplanarDetailTiling;
			float _Detailnormalscale;
			float _Normalscale;
			float _Triplanarvalue;
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord372 = IN.ase_texcoord7.xy * temp_cast_0 + float2( 0,0 );
				float4 tex2DNode2 = tex2D( _Albedo, texCoord372 );
				float4 triplanar244 = TriplanarSampling244( _TriplanarAlbedo, WorldPosition, WorldNormal, 8.0, _TriplanarTiling, 1.0, 0 );
				float4 temp_output_328_0 = ( triplanar244 * _TriplanarColor );
				float3 unpack3 = UnpackNormalScale( tex2D( _Normalmap, texCoord372 ), _Normalscale );
				unpack3.z = lerp( 1, unpack3.z, saturate(_Normalscale) );
				float3 tex2DNode3 = unpack3;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal392 = tex2DNode3;
				float3 worldNormal392 = float3(dot(tanToWorld0,tanNormal392), dot(tanToWorld1,tanNormal392), dot(tanToWorld2,tanNormal392));
				float2 uv_DetailNormal = IN.ase_texcoord7.xy * _DetailNormal_ST.xy + _DetailNormal_ST.zw;
				float3 unpack7 = UnpackNormalScale( tex2D( _DetailNormal, uv_DetailNormal ), _Detailnormalscale );
				unpack7.z = lerp( 1, unpack7.z, saturate(_Detailnormalscale) );
				float3x3 ase_worldToTangent = float3x3(WorldTangent,WorldBiTangent,WorldNormal);
				float3 triplanar364 = TriplanarSampling364( _TriplanarDetailNormal, WorldPosition, WorldNormal, 8.0, _TriplanarDetailTiling, _Detailnormalscale, 0 );
				...
				#else
				float3 staticSwitch365 = unpack7;
				#endif
				float3 temp_output_92_0 = BlendNormal( staticSwitch365 , tex2DNode3 );
				float3 tanNormal305 = temp_output_92_0;
				float3 worldNormal305 = float3(dot(tanToWorld0,tanNormal305), dot(tanToWorld1,tanNormal305), dot(tanToWorld2,tanNormal305));
				#ifdef _USEDETAIL_ON
				float staticSwitch393 = worldNormal305.y;
				#else
				float staticSwitch393 = worldNormal392.y;
				#endif
				float4 tex2DNode396 = tex2D( _Detailmask, texCoord372 );
				...
				float4 triplanar237 = TriplanarSampling237( _Noise, WorldPosition, WorldNormal, 6.0, _NoiseTiling, 1.0, 0 );
				...
				float2 uv_DetailAlbedo = IN.ase_texcoord7.xy * _DetailAlbedo_ST.xy + _DetailAlbedo_ST.zw;
				float temp_output_9_0_g14 = tex2DNode396.r;
				float temp_output_18_0_g14 = ( 1.0 - temp_output_9_0_g14 );
				float3 appendResult16_g14 = (float3(temp_output_18_0_g14 , temp_output_18_0_g14 , temp_output_18_0_g14));
				float4 triplanar368 = TriplanarSampling368( _TriplanarDetailAlbedo, WorldPosition, WorldNormal, 8.0, _TriplanarDetailTiling, 1.0, 0 );
				...
				#else
				float3 staticSwitch375 = ( tex2DNode2.rgb * ( ( ( (tex2D( _DetailAlbedo, uv_DetailAlbedo )).rgb * (unity_ColorSpaceDouble).rgb ) * temp_output_9_0_g14 ) + appendResult16_g14 ) );
				#endif
				...
				float3 triplanar243 = TriplanarSampling243( _TriplanarNormal, WorldPosition, WorldNormal, 8.0, _TriplanarTiling, _TriplanarNormalScale, 0 );
				float3 tanTriplanarNormal243 = mul( ase_worldToTangent, triplanar243 );
				float3 lerpResult343 = lerp( tanTriplanarNormal243 , BlendNormal( tex2DNode3 , tanTriplanarNormal243 ) , _Blendnormals);
				...
				float dotResult362 = dot( IN.ase_tangent.xyz , WorldViewDirection );
				float4 triplanar348 = TriplanarSampling348( _Snownoise, WorldPosition, WorldNormal, 8.0, _SnownoiseTiling, 1.0, 0 );
				...
				float3 Albedo = ( staticSwitch389 * _Color ).xyz;
				float3 Normal = staticSwitch369;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = tex2DNode4.r;
				float Smoothness = staticSwitch370;
				float Occlusion = pow( tex2D( _AmbientOcclusion, uv_AmbientOcclusion ).r , _AOscale );
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord372 = IN.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
				float4 tex2DNode2 = tex2D( _Albedo, texCoord372 );
				float3 ase_worldNormal = IN.ase_texcoord3.xyz;
				float4 triplanar244 = TriplanarSampling244( _TriplanarAlbedo, WorldPosition, ase_worldNormal, 8.0, _TriplanarTiling, 1.0, 0 );
				float4 temp_output_328_0 = ( triplanar244 * _TriplanarColor );
				float3 unpack3 = UnpackNormalScale( tex2D( _Normalmap, texCoord372 ), _Normalscale );
				unpack3.z = lerp( 1, unpack3.z, saturate(_Normalscale) );
				float3 tex2DNode3 = unpack3;
				...
				float3 triplanar364 = TriplanarSampling364( _TriplanarDetailNormal, WorldPosition, ase_worldNormal, 8.0, _TriplanarDetailTiling, _Detailnormalscale, 0 );
				float3 tanTriplanarNormal364 = mul( ase_worldToTangent, triplanar364 );
				#ifdef _TRIPLANARDETAILUSEINSTEAD_ON
				float3 staticSwitch365 = tanTriplanarNormal364;
				#else
				...
				#endif
				float dotResult22 = dot( _Triplanarvalue , staticSwitch397 );
				float4 triplanar237 = TriplanarSampling237( _Noise, WorldPosition, ase_worldNormal, 6.0, _NoiseTiling, 1.0, 0 );
				float lerpResult282 = lerp( dotResult22 , ( triplanar237.x * _Noisevalue ) , _Overlaynoise);
				#ifdef _USENOISE_ON
				float staticSwitch374 = lerpResult282;
				#else
				...
				float temp_output_18_0_g14 = ( 1.0 - temp_output_9_0_g14 );
				float3 appendResult16_g14 = (float3(temp_output_18_0_g14 , temp_output_18_0_g14 , temp_output_18_0_g14));
				float4 triplanar368 = TriplanarSampling368( _TriplanarDetailAlbedo, WorldPosition, ase_worldNormal, 8.0, _TriplanarDetailTiling, 1.0, 0 );
				float temp_output_9_0_g13 = tex2DNode396.r;
				float temp_output_18_0_g13 = ( 1.0 - temp_output_9_0_g13 );
				float3 appendResult16_g13 = (float3(temp_output_18_0_g13 , temp_output_18_0_g13 , temp_output_18_0_g13));
				#ifdef _TRIPLANARDETAILUSEINSTEAD_ON
...
/*ASEBEGIN
Version=18935
360;321;1080;466;1177.898;119.7693;1.924305;True;False
...
Node;AmplifyShaderEditor.StaticSwitch;365;-2017.502,-1350.433;Inherit;False;Property;_Triplanardetailuseinstead;Triplanar detail use instead;16;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;397;-3209.024,-121.4259;Inherit;False;Property;_Usedetailmaskfortriplanar;Use detail mask for triplanar;22;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;376;-2048.582,-1110.948;Inherit;False;Detail Albedo;9;;14;29e5a290b15a7884983e27c8f1afaa8c;0;3;12;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;9;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;374;-2427.591,793.0771;Inherit;False;Property;_UseNoise;Use Noise;33;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;404;617.9836,-0.2000937;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;400;617.9836,-0.2000937;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;401;617.9836,-0.2000937;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;KumaBeer/Stone_snow;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,-1;0;Translucency;0;0;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;6;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;402;617.9836,-0.2000937;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;403;617.9836,-0.2000937;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;405;617.9836,-0.2000937;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;401;0;34;0
WireConnection;401;1;369;0
WireConnection;401;3;4;1
WireConnection;401;4;370;0
WireConnection;401;5;264;0
ASEEND*/
//CHKSM=8022DC2410031B3ED42D8ECC5A2B8F5B1E6D61D4